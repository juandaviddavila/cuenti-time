...
- THEN the build completes without type errors
- AND no unused imports or unreferenced properties remain
...
- BUT the field is NOT persisted (Prisma spread drops it since the column stays but validation doesn't forward it)
