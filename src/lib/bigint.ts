...
/** Convert BigInt to decimal string. Pass-through for null/undefined. */
...
export function bigintToString(value: bigint | null | undefined): string | null | undefined;
export function bigintToString(value: bigint | null | undefined): string | null | undefined {
...
/** Parse decimal string to BigInt. Throws on non-numeric input. */
export function stringToBigint(value: string): bigint;
export function stringToBigint(value: string | null): bigint | null;
export function stringToBigint(value: string | undefined): bigint | undefined;
export function stringToBigint(value: string | null | undefined): bigint | null | undefined {
  if (value === null) return null;
  if (value === undefined) return undefined;
...
export function serializeRecord<T>(record: T): T {
  return JSON.parse(JSON.stringify(record, bigintReplacer)) as T;
}
